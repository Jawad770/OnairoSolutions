...
ONAIRO.blogPosts = [
  {
    ...
    minutes: 5,
    thumb: 'alt0',
    related: ['portfolio/index.html', 'services/index.html', 'pages/request-quote.html'],
  },
  {
    ...
    minutes: 7,
    thumb: 'alt1',
    related: ['services/index.html', 'products/index.html', 'pages/contact.html'],
  },
  {
    ...
    minutes: 6,
    thumb: 'alt2',
    related: ['products/edutrack.html', 'products/index.html', 'pages/request-quote.html'],
  },
  {
    ...
    minutes: 8,
    thumb: 'alt3',
    related: ['pages/about.html', 'services/index.html', 'pages/contact.html'],
  },
  {
    ...
    minutes: 4,
    thumb: 'alt4',
    related: ['portfolio/index.html', 'pages/request-quote.html'],
  },
  {
    id: 'practical-ai',
    ...
    minutes: 6,
    thumb: 'alt5',
    related: ['services/index.html', 'pages/contact.html'],
  },
  {
    ...
    minutes: 6,
    thumb: 'alt1',
    related: ['portfolio/index.html', 'pages/blog.html', 'pages/contact.html'],
  },
  {
    ...
    minutes: 5,
    thumb: 'alt3',
    related: ['services/index.html', 'pages/request-quote.html'],
  },
];
