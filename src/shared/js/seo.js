...
(function () {
  ...
  function websiteSchema() {
    return {
      ...
      potentialAction: {
        '@type': 'SearchAction',
        target: abs('src/portfolio/index.html') + '?q={search_term_string}',
  ...
  function serviceSchema() {
    return {
      ...
      url: abs('src/services/index.html'),
    };
  }
    ...
    return [
      {
        ...
        url: abs('src/products/edutrack.html'),
      ...
      },
      {
        ...
        description: 'Windows school ERP for schools — fees, attendance, payroll, ID cards, and reports.',
