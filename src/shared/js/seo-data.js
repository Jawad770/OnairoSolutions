...
ONAIRO.seoPages = {
  ...
  services: {
    ...
    path: '/src/services/',
    pathHtml: 'src/services/index.html',
    type: 'website',
  ...
  edutrack: {
    ...
    path: '/src/products/edutrack.html',
    pathHtml: 'src/products/edutrack.html',
    type: 'product',
  ...
  pricing: {
    ...
    pathHtml: 'src/pages/pricing.html',
    type: 'website',
    breadcrumbs: [
      { name: 'Home', path: '/' },
  ...
  blog: {
    ...
    pathHtml: 'src/pages/blog.html',
    type: 'website',
    breadcrumbs: [
      { name: 'Home', path: '/' },
      { name: 'Blog', path: '/src/pages/blog.html' },
    ],
  },
  contact: {
    ...
    pathHtml: 'src/pages/contact.html',
    type: 'website',
    breadcrumbs: [
      { name: 'Home', path: '/' },
  ...
  quote: {
    ...
    path: '/src/pages/request-quote.html',
    pathHtml: 'src/pages/request-quote.html',
    type: 'website',
    breadcrumbs: [
      { name: 'Home', path: '/' },
      { name: 'Request Quote', path: '/src/pages/request-quote.html' },
    ],
  },
  industries: {
